...
<body>
    ...
    <nav class="navbar navbar-dark fixed-top bg-dark">
      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="{{ asset('img/p1.jpg')}}" class="d-block w-100" alt="...">
      ...
      <div class="container" id="seccion1">
        ...
        <div class="row">
            <div class="col-2 cuadro" style="background-color: red;">a</div>
            <div class="col-4 cuadro">a</div>
            <div class="col-4 cuadro">a</div>
            <div class="col-2 cuadro">a</div>
      ...
      <div class="container">
          <div class="row col"><div class="accordion" id="accordionExample">
